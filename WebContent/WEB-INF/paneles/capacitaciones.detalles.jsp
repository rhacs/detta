                                    ...
                                    <form action="${ pageContext.request.contextPath }/panel/capacitaciones/" method="post">
                                        <div class="form-row">
                                            <div class="form-group col-lg-2 col-md-4 col-sm-12">
                                                ...
                                                <input type="date" name="fecha" id="fecha" value="${ capacitacion != null ? capacitacion.getFecha() : '' }" ${ disabled } required>
                                            </div>
                                            <div class="form-group col-lg-10 col-md-8 col-sm-12">
                                                <label for="direccion">Dirección</label>
                                                <input type="text" name="direccion" id="direccion" value="${ capacitacion != null ? capacitacion.getDireccion() : '' }" ${ disabled } required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="tema">Tema</label>
                                            <input type="text" name="tema" id="tema" value="${ capacitacion != null ? capacitacion.getTema() : '' }" ${ disabled } required>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group col-auto">
                                                <label for="participantes">Participantes</label>
                                                <input type="number" name="participantes" id="participantes" value="${ capacitacion != null ? capacitacion.getParticipantes() : '' }" ${ disabled } required>
                                            </div>

                                            <core:if test="${ rol != 'empresa' }">
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="realizada">Estado</label>
                                                <select name="realizada" id="realizada" ${ disabled } required>
                                        ...
                                        <core:choose>
                                            <core:when test="${ rol == 'admin' }">
                                                <div class="form-group">
                                                    ...
                                                    <select name="profesionalId" id="profesionalId" ${ disabled } required>
                                            ...
                                            <core:when test="${ rol == 'empresa' }">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="profesional" id="profesional" value="${ profesional.getNombre() }" disabled required>
                                        ...
                                        <core:choose>
                                            <core:when test="${ rol != 'empresa' }">
                                                <div class="form-group">
                                                    ...
                                                    <select name="empresaId" id="empresaId" ${ disabled } required>
